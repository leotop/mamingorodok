...
$sUrl = "/orderresult/orderresult.cfm";
$sVars = "Ordernumber=".$ORDER_ID."&Merchant_ID=".$assist_Shop_IDP."&Login=".$assist_LOGIN."&Password=".$assist_PASSWORD."&Format=3";
$aDesc = array(
...
if ($sResult <> "")
{
	...
	file_put_contents($_SERVER["DOCUMENT_ROOT"]."/fd.txt",$sVars);
	$objXML = new CDataXML();
