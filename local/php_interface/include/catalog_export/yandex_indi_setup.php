        ...
        <table width="100%" class="edit-table">
            <tr>
                ...
                <td width="100%" valign="top">
                    <select name="IBLOCK_ID" id="IBLOCK_ID" OnChange="document.getElementById('id_ifr').src='/bitrix/tools/catalog_export/yandex_indi_util.php?IBLOCK_ID='+this[this.selectedIndex].value;">
...
//                                        space = '<input type="checkbox" name="V[]" value="'+i+'"><a href="' + Tree[node][i][1] + '">' + Tree[node][i][0] + '</a>';
                    ...
                    <iframe src="/bitrix/tools/catalog_export/yandex_indi_util.php?IBLOCK_ID=<?=intval($IBLOCK_ID)?>" id="id_ifr" name="ifr" style="display:none"></iframe>
                    <br><br>
                </td>
            </tr>
...
function showDetailPopup()
{
    if (null == obDetailWindow)
    {
        ...
        var obDetailWindow = new BX.CAdminDialog({
            'content_url': '/bitrix/tools/catalog_export/yandex_indi_detail.php?lang=<?=LANGUAGE_ID?>&bxpublic=Y&IBLOCK=' + s[s.selectedIndex].value,
...
function setDetailData(data)
{
    BX('XML_DATA').value = data;
            ...
            <tr>
                ...
                <td width="100%" valign="top">
                    <font class="text">
                    <?echo GetMessage("CET_SAVE_FILENAME");?> <b><?=COption::GetOptionString("catalog", "export_default_path", "/bitrix/catalog_export/")?></b><input type="text" name="SETUP_FILE_NAME" value="<?echo (strlen($SETUP_FILE_NAME)>0) ? htmlspecialchars($SETUP_FILE_NAME) : "yandex_indi.php" ?>" size="50" />
                    </font>
                    <br><br>
                </td>
            </tr>
