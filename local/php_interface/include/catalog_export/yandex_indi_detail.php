<?
    ...
    if ($_SERVER['REQUEST_METHOD'] == 'POST' && strlen($_REQUEST['save'])>0)
    {
        ...
        $availability = intval($_POST["load_availability"]);
        $null_price  = intval($_POST["load_null_price"]);
...
<tr class="heading">
    <td colspan="2" valign="top">Настройки</td>
</tr>
<tr>
    <td colspan="2" valign="top"><input type="checkbox" name="load_availability" id="load_availability" value="1"><label for="load_availability">Выгружать имеющиеся в наличии товары</label></td>
</tr>
<tr>
    <td colspan="2" valign="top"><input type="checkbox" name="load_null_price" id="load_null_price" value="1"><label for="load_null_price">Выгружать товары с ценой 0</label></td>
</tr>
<tr class="heading">
