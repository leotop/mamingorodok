...
if (!empty($arResult['ITEMS']))
{
    ...
    <div class="crumbs_black_big element">Просматриваемые с этим товаром</div>
    <div class="crumbs_black_big basket">Продаваемые с этим товаром</div>
    ...
    $price=GetOfferMinPrice(2,$arItem["ID"]);
        ...
        <?  //arshow($arItem["PREVIEW_PICTURE"],true);
          ...
          ?>
            ...
            <?//arshow($arItem["CATALOG_QUANTITY"])?> 
            <?if(!empty($price)){ ?>
