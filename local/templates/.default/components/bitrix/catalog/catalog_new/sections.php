...
<br>
<?$APPLICATION->IncludeComponent("bitrix:catalog.top", "main-block-new", array(
		"IBLOCK_TYPE" => "catalog",
		"IBLOCK_ID" => "2",
...
<?$APPLICATION->IncludeComponent("bitrix:catalog.top", "main-block-sale", array(
	"IBLOCK_TYPE" => "catalog",
	"IBLOCK_ID" => "2",
...
<?$APPLICATION->IncludeComponent("bitrix:catalog.top", "main-block-popular", array(
	"IBLOCK_TYPE" => "catalog",
	"IBLOCK_ID" => "2",
...
<?$APPLICATION->IncludeComponent("bitrix:catalog.top", "main-block-having", array(
	"IBLOCK_TYPE" => "catalog",
	"IBLOCK_ID" => "2",
