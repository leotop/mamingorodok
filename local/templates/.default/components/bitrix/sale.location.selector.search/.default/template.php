	...
	<div id="sls-<?=$arResult['RANDOM_TAG']?>" class="bx-sls <?if(strlen($arResult['MODE_CLASSES'])):?> <?=$arResult['MODE_CLASSES']?><?endif?>">
		...
		<div class="dropdown-block bx-ui-sls-input-block">
           ...
           //  arshow($_SESSION , true)?>
			...
			<input type="text" autocomplete="off" name="<?=$arParams['INPUT_NAME']?>" value="<?=($arResult['VALUE'] == "")?$arData:$arResult['VALUE'];?>" class="dropdown-field" placeholder="<?=Loc::getMessage('SALE_SLS_INPUT_SOME')?> ..." />
