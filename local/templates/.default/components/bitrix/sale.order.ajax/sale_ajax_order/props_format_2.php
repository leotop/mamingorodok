                ...
                <div>
                    ...
                    foreach ($arSource as $arProperties)
                    {
                        ...
                        elseif ($arProperties["TYPE"] == "TEXT")
                        {
                            ...
                            <div class="bx_block r3x1">
                                <input type="text" placeholder="<?=$arProperties["NAME"]?>" maxlength="250" size="<?=$arProperties["SIZE1"]?>" value="<?if($_POST["DELIVERY_ID"] == 1){echo "г. Москва м. Рязанский проспект";}else{?><?if($arProperties["VALUE"] ==""){echo $userSelCity;}else{echo $arProperties["VALUE"];}?><?}?>" name="<?=$arProperties["FIELD_NAME"]?>" id="<?=$arProperties["FIELD_NAME"]?>" />
                        ...
                        elseif ($arProperties["TYPE"] == "SELECT")
                        {
                            ...
                            <?
                            if($arProperties['CODE'] == "DELIVERY_TIME" or $arProperties['CODE'] == "DELIVERY_TIME_PICKUP"){
