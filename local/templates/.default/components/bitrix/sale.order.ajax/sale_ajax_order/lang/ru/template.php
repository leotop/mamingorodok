...
$MESS['SOA_TEMPL_BUTTON'] = "Подтвердить и отправить заказ";
$MESS['SOA_TEMPL_PROP_INFO'] = "Доставка";
...
$MESS['SOA_TEMPL_ORDER_SUC'] = "Ваш заказ  №#ORDER_ID# от <span>#ORDER_DATE# принят.</span>";
$MESS['SOA_TEMPL_ORDER_SUC1'] = "Оплатить заказ банковской картой, по квитанции через отделение банка или электронными деньгами, можно после подтверждения 
наличия товара нашим менеджером из <a href=\"#LINK#\">Вашего личного кабинета</a>.";
...
$MESS['SOA_TEMPL_SUM_NAME'] = "Наименование товара";
...
$MESS['SALE_DELIV_PRICE'] = "Стоимость доставки";
