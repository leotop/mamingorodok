...
<? // если пользователь смотрит свой список друзей ?>
<?if ($current_user_id == $user_id):?>    

    <div class="choose" style="width:350px;">
        <span class="active"><span><a href="/community/user/<?=$user_id?>/friends/">Все</a></span></span>
        <span><span><a href="/community/user/<?=$user_id?>/friends/invite/">Пригласить друзей</a></span></span>
...
<?else: // если смотрит чужой список друзей?>
