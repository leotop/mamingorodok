...
<?foreach($arResult["LINKED_ITEMS"] as $arLinkedItem):?>
    <div id="linked-item-id-<?=$arLinkedItem["ID"]?>">
        ...
        <div class="price"><?=CurrencyFormat($arLinkedItem["PRICE"], 'RUB');?></div>
        <div class="old-price"><?=CurrencyFormat($arLinkedItem["PROPERTY_OLD_PRICE_VALUE"], 'RUB');?></div>
...
<div id="DetailPhotoChoose">    
    ...
    <div id="ChooseBlock">
        ...
        <div class="round_plash">
            ...
            <?if(intval($arResult["PROPERTIES"]['URL_SIZE']['VALUE'])>0):?>
    ...
    <div class="yellow_plash" id="Basketplash">
        ...
        <?//xvar_dump($arResult["PROPERTIES"]["QU_ACTIVE"])?>
			...
			<?if(isset($arResult["DISPLAY_PROPERTIES"]["OLD_PRICE"]["VALUE"])):?>
                <div class="OldPrice"><?=$arResult["DISPLAY_PROPERTIES"]["OLD_PRICE"]["VALUE"]?></div>
			<?endif?>
            <div class="Price"><?=$arResult["DISPLAY_PROPERTIES"]["PRICE"]["VALUE"]?></div>
