...
foreach($arResult["ITEMS"] as $k => $arItem)
{
	...
	if(!$USER->IsAuthorized()):
		$arResult["ITEMS"][$k]["ADD_TO_WISH"] = '<div id="BabyList"><div class="BabyListCenter"><div class="DIcon" ></div> <a class="showpUp greydot heartDICON" href="#messageNoUser1">В список малыша</a><div class="clear"></div></div></div>';
	else:	  
