...
if($ElementID > 0)
{
	...
	if($USER->GetID() > 0)
	{
		...
		if($isInBabyList>0)
			$add_to_wish_list_link = '<a href="/community/user/'.$USER->GetID().'/" title="Уже в списке малыша"><img src="/bitrix/templates/nmg/img/icon2.png" width="13" height="11" alt="Уже в списке малыша" /><span>Уже в списке малыша</span></a>';
		else $add_to_wish_list_link = '<a class="add addToBabyList" href="#" title="В список малыша"><img src="/bitrix/templates/nmg/img/icon2.png" width="13" height="11" alt="" /><span>В список малыша</span></a>';
	} else $add_to_wish_list_link = '<a class="showpUp" href="#messageNoUser1" title="В список малыша"><img src="/bitrix/templates/nmg/img/icon2.png" width="13" height="11" alt="" /><span>В список малыша</span></a>';
