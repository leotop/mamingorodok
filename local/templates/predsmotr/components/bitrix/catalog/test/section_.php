...
$res = CIBlockSection::GetList(array(), array("IBLOCK_ID" => CATALOG_IBLOCK_ID, "SECTION_ID"=>$arResult["VARIABLES"]["SECTION_ID"]), false, array());
...
?>
<?
// получаем название текущей секции (для хлебной крошки)
CModule::IncludeModule('iblock');
$res = CIBlockSection::GetList(array(), array("IBLOCK_ID" => CATALOG_IBLOCK_ID, "ID"=>$arResult["VARIABLES"]["SECTION_ID"]), false, array("UF_DESCR_TITLE"));
if($arSect = $res->GetNext())
{
...
<?if ($IS_PARENT_SECTION && empty($GLOBALS["arrLeftFilter"])):?>
    ...
    <div class="goods">
        ...
        <div class="item_list">
            ...
            <?$APPLICATION->IncludeComponent("bitrix:catalog.section", "main-block", array(
                "IBLOCK_TYPE" => "catalog",
                "IBLOCK_ID" => "2",
                "SECTION_ID" => $arResult["VARIABLES"]["SECTION_ID"],
               // "SECTION_CODE" => $arResult["VARIABLES"]["SECTION_CODE"],
