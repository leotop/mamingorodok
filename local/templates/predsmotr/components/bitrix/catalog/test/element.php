    ...
    if($ElementID > 0)
    {
        ...
        if($USER->GetID() > 0)
        {
            ...
            if(!empty($arResult["ITEMS"][$ElementID]))
                $add_to_wish_list_link = '<a id="deleteFromWishList" data-id="'.$arResult["ITEMS"][$ElementID]["ID"].'"  title="Вам понравилось"><img src="/bitrix/templates/nmg/img/icon2.png" width="13" height="11" alt="Вам понравилось" /><span>Вам понравилось</span></a>';
            else $add_to_wish_list_link = '<a class="add addToLikeList" data-id="'.$ElementID.'"  title="Мне нравится"><img src="/bitrix/templates/nmg/img/grey-heart.png" width="13" height="11" alt="" /><span>Вам понравилось</span></a>';
        } else $add_to_wish_list_link = '<a class="showpUp" href="#messageNoUser1" title="Мне нравится"><img src="/bitrix/templates/nmg/img/grey-heart.png" width="13" height="11" alt="" /><span>Вам понравилось</span></a>';
        ...
        <div class="white_plash">
            ...
            <div class="content">
                <div class="content">
                    <div class="content">
                        <div class="clear"></div>
                        Для того чтобы добавить товар в список "Вам понравилось" требуется <a href="/personal/registaration/">регистрация</a> или <a href="/personal/profile/">авторизация</a>.
                    </div>
                </div>
            </div>
            <div class="cn bl"></div>
