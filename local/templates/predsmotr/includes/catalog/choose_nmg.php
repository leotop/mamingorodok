...
?>
<?if($USER->IsAdmin()){arshow($_REQUEST["orderby"]);}?>
<ul class="sorting_list">
	...
	{  
		...
		if ($_REQUEST["orderby"] == $arItem["CODE"] || count($arChoose) == 1)
		{
            ...
            <a title="<?=$APPLICATION->GetCurPageParam('orderby='.$arItem["CODE"].'&sort=DESC', array('sort', 'orderby', "producerCode", "sef"))?>"><?=$arItem["NAME"]?></a><?
		}
		echo '</li>';
	}?>
