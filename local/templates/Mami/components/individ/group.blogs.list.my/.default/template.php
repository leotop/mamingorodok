...
<?global $USER;?>
<?if (!empty($arResult)):?>
<div class="title">Блоги, в которых я состою</div>
    ...
    <div class="block">
        ...
        ?>        
        <?if ($owner_id > 0):?>
            <div class="autor">Создатель: <a class="grey" href="/community/user/<?=$owner_id?>/"><?=ShowFullName($arOwner["NAME"], '', $arOwner["LAST_NAME"])?></a></div>
        <?endif?>
