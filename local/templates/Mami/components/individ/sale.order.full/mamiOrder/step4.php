...
<p class="pnk hl3"><b>Доставка:</b> <span class="dostav"><?=intval($arResult["DELIVERY_PRICE"])?></span> руб.</p>
<p class="pnk hl2"><b>Итого:</b> <span class="itogo"><?=$arResult["ORDER_PRICE"]-$arResult["SALE"]+$arResult["DELIVERY_PRICE"]?></span> руб.</p>
