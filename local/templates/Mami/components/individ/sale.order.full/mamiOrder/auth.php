...
<table border="0" cellspacing="0" cellpadding="1">
	<tr >
		<td valign="top" class="auths">
			...
			<form method="post" action="<?= $arParams["PATH_TO_ORDER"] ?>"  class="jqtransform" name="order_auth_form">
...
?>
		...
		<td valign="top" width="100%">
			<?if($arResult["AUTH"]["new_user_registration"]=="Y"):?>
				...
				<form method="post"  class="jqtransform" action="<?= $arParams["PATH_TO_ORDER"]?>" name="order_reg_form">
					<table class="sale_order_full_table">
