        ...
        <div class="item<?if($i+1 == count($arResult["ITEMS"])):?> last<?endif?>">
			...
			<?if(is_array($arItem["PRODUCT"])):?>
				<div class="right-right">
					...
					<?if($arItem["HAVEBUY"]>0):?>
					<input type="submit" class="orange add-to-basket-button" value="Купить" />
					<a class="add-to-basket" href="/select-color-and-size.php?id=<?=$arItem["PRODUCT"]["ID"]?>&quantity=1" style="display:none;"></a>
					<?else:?>
