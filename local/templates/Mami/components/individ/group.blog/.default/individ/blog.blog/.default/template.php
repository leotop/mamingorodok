...
if(count($arResult["POST"])>0)
{
	...
	elseif($CurPost["TYPE"]==ADD_REPORT_TYPE):
		//print_R($CurPost);
		?>
		<div class="st">Я <?if($CurPost["GENDER"]=="M"):?>запросил<?else:?>запросила<?endif?> отзыв у <a href="/comunity/blog/<?=$CurPost["REPORT_USER_BLOG"]?>/"><?=$CurPost["REPORT_USER"]?></a> на товар <br>
		</div>
		<div class="clear"></div>
		<?if($CurPost["PRODUCT"]["PREVIEW_PICTURE"]>0):?>
