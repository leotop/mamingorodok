...
if($ElementID > 0)
{
	...
	$uwant = '<a href="#FriendsWant" class="showpUp">'.$users_friends_want.' '.WordsForNumbers($users_friends_want, 'друг', 'друга', 'друзей').'</a><br><a href="#UsersWant" class="showpUp">'.$users_want.' '.WordsForNumbers($users_want, 'пользователь', 'пользователя', 'пользователей').'</a>';

	$uhave = '<a href="#FriendsHave" class="showpUp">'.$users_friends_have.' '.WordsForNumbers($users_friends_have, 'друг', 'друга', 'друзей').'</a><br><a href="#UsersHave" class="showpUp">'.$users_have.' '.WordsForNumbers($users_have, 'пользователь', 'пользователя', 'пользователей').'</a>';
