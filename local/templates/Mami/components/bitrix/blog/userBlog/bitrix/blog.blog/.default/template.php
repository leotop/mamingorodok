...
if(!empty($arResult["ERROR_MESSAGE"]))
{
	...
	if($MyBlog!="BLOG"){
		...
		?>
			...
			<div class="rait"><span class="rating">Рейтинг:</span> <?if(intval($arResult["RATING"])>0):?>+<?endif?><?=$arResult["RATING"]?> <span class="rating">Статус:</span> <?=GetStatusByRatingValue($arResult["RATING"], $arStatusList);?></div>
			</div>
			<div class="clear"></div>
			<div class="text">
