...
//***********************************
?>
<form class="jqtransform" action="<?=$arResult["FORM_ACTION"]?>" method="post">
...
<tr valign="top">
	<td width="40%">
		...
		<?foreach($arResult["RUBRICS"] as $itemID => $itemValue):?>
			<label><input type="checkbox" name="RUB_ID[]" value="<?=$itemValue["ID"]?>"<?if($itemValue["CHECKED"]) echo " checked"?> /><span class="compare_link"><?=$itemValue["NAME"]?></span></label><br />
		<?endforeach;?></p>
		<div class="clear"></div>
...
<tfoot><tr><td colspan="2">
	<div class="input-f"><input type="submit" name="Save" value="<?echo ($arResult["ID"] > 0? GetMessage("subscr_upd"):GetMessage("subscr_add"))?>" /></div>
