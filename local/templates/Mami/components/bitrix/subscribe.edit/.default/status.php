...
//***********************************
?>
<form class="jqtransform" action="<?=$arResult["FORM_ACTION"]?>" method="get">
<table width="100%" border="0" cellpadding="0" cellspacing="0" class="data-table">
	...
	<?if($arResult["SUBSCRIPTION"]["CONFIRMED"] == "Y"):?>
		...
		<?if($arResult["SUBSCRIPTION"]["ACTIVE"] == "Y"):?>
			<div class="input-f"><input type="submit" name="unsubscribe" value="<?echo GetMessage("subscr_unsubscr")?>" /></div>
			<input type="hidden" name="action" value="unsubscribe" />
		<?else:?>
			<div class="input-f"><input type="submit" name="activate" value="<?echo GetMessage("subscr_activate")?>" /></div>
