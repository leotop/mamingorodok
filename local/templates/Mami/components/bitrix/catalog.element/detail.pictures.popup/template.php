...
<div class="DPicture bpictureCenter">
	...
	<div class="DPictureList<?if ((count($arResult["PROPERTIES"]["IMG_BIG"]["VALUE"]) + 1 + $i) > 10):?> DPictureListCarousel2<?else:?> DPictureListCarouselNwsSize2<?endif;?>">
		<ul>
			<li>
				<a href="/inc/picture_view.php?ELEMENT_ID=<?=$_REQUEST["ELEMENT_ID"]?>&IMG_ID=<?=$arResult["DETAIL_PICTURE"]["ID"]?>"><img src="<?=MegaResizeImage($arResult["DETAIL_PICTURE"]["ID"], 32, 32)?>" /></a>
		...
		<?if(intval($arColorItem["PROPERTY_PICTURE_MINI_VALUE"])>0 && intval($arColorItem["PROPERTY_PICTURE_MIDI_VALUE"])>0 && intval($arColorItem["PROPERTY_PICTURE_MAXI_VALUE"])>0):?>
			<li>
				<a href="/inc/picture_view.php?ELEMENT_ID=<?=$_REQUEST["ELEMENT_ID"]?>&IMG_ID=<?=$arColorItem["PROPERTY_PICTURE_MAXI_VALUE"]?>"><img src="<?=MegaResizeImage($arColorItem["PROPERTY_PICTURE_MINI_VALUE"], 32, 32)?>" /></a>
