...
<?endif;?>
	...
	<div class="clear"></div>
	<input type="submit" value="Купить и подарить" class="purple" id="certificateBuyBtnForUser"><br>
	<p class="infopay">Оплата производится через систему <a href="http://www.assist.ru/">Assist</a> банковской картой</p>
	<p class="infopayinfo"><a href="/certificates/" target="_blank">Как использовать сертификат?</a></p>
</div>
