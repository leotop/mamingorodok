...
//******************************************
?>
<form class="jqtransform" action="<?echo $arResult["FORM_ACTION"].($_SERVER["QUERY_STRING"]<>""? "?".htmlspecialchars($_SERVER["QUERY_STRING"]):"")?>" method="post">
...
<form class="jqtransform" action="<?=$arResult["FORM_ACTION"]?>">
<table width="100%" border="0" cellpadding="0" cellspacing="0" class="data-table">
...
<tfoot><tr><td colspan="2"><div class="input-f"><input type="submit" name="sendpassword" value="<?echo GetMessage("subscr_pass_button")?>" /></div></td></tr></tfoot>
</table>
