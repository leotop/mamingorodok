...
<input type="hidden" name="ID" value=<?=$arResult["ID"]?> />
	...
	<table class="sex">
	<tr><td>
	<input type="radio" name="PERSONAL_GENDER" value="M" checked /><span class="pol">Мальчик</span>
	</td><td>
	<input type="radio" name="PERSONAL_GENDER" value="F" /><span class="pol">Девочка</span>
	</td></tr>
	</table>
	<div class="clear"></div>
	...
	<!--<label>Электронная почта (используется как логин)</label>
	<div class="clear"></div>
	...
	<div class="input-f">
	<input type="submit" name="save" id="saveProfile" value="<?=(($arResult["ID"]>0) ? "Сохранить изменения" : GetMessage("MAIN_ADD"))?>">&nbsp;&nbsp;<input type="reset" value="Отмена">
	</div>
</form>