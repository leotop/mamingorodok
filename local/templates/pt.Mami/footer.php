...
<div id="certificates-selector" class="CatPopUp">
    <div class="white_plash">
    <div class="exitpUp"></div>
    <div class="cn tl"></div>
    <div class="cn tr"></div>
    <div class="content"><div class="content"><div class="content"> <div class="clear"></div>
        ...
        <div class="sub-title">Мои сертификаты</div>
        <?for($i=1; $i<=2; $i++):?>
            <div class="certificate-item<?if($i % 3 == 0):?> last<?endif?>">
                <div class="image"></div>
        ...
        <?endfor?>
        <div class="clear"></div>
        <div class="sum">Выбрано на <span>500</span> <span>рублей</span></div>
        <input type="submit" class="purple" value="Подарить" />
        ...
        <?endfor?>
        <div class="clear"></div>
        <div class="sum">Выбрано на <span>6 500</span> <span>рублей</span></div>
        <input type="submit" class="purple" value="Купить и подарить" />
...
<div id="add-my" class="CatPopUp">
    ...
    <div class="content"><div class="content"><div class="content"> <div class="clear"></div>
        ...
        <form class="jqtransform">
            <div class="el-address"><textarea class="add-my"></textarea></div>
			<div class="clear"></div>
            <div class="top10"><input type="submit" class="purple" value="Отправить" /></div>
        </form>
        <div class="clear"></div>
