	...
	<div class="sk-toppane-wrap">
		<div class="sk-toppane">
			<ul class="sk-top-menu">
				<li><?=showNoindex()?><a href="/how-to-buy/" rel="nofollow" title="Помощь покупателю">Помощь покупателю</a><?=showNoindex(false)?></li>
				<li class="sk-top-menu_sel"><a href="#" title="Обратная связь" id="feedbackFormHref">Обратная связь</a></li>
				<li><a href="/credit/" title="">Покупка в кредит</a></li>
			</ul>
	...
	false
		...
		<div class="sk-action">
			...
			<div class="sk-action--credit">
				<!--<a href="/credit/" title="Кредит на весь ассортимент магазина"><img src="/bitrix/templates/nmg/img/header/buy-in-credit.png" alt="Кредит на весь ассортимент магазина"></a>-->
				<a href="/credit/" class="sk-action--credi--head" title="Кредит на весь ассортимент магазина">Покупка товаров в кредит</a>
				
				<a href="/credit/" title="Кредит на весь ассортимент магазина">Кредит на весь ассортимент магазина</a>
			</div>
		</div>
