...
<?if(strlen($arResult["ERROR_MESSAGE"])<=0):?>
	...
	<tr>
		<th colspan="2"><a name="pay"></a><b><?=GetMessage("P_ORDER_PAYMENT")?></b></th>
	</tr>
	<tr>
	...
	if ($arResult["CAN_REPAY"]=="Y" && $arResult["STATUS_ID"] == "A")
	{
		?>
		<tr>
			<td colspan="2" align="center">
				...
				{
					?>
					<a href="<?=$arResult["PAY_SYSTEM"]["PSA_ACTION_FILE"]?>" target="_blank">Оплатить заказ</a>
					<?
				}
				else
				{
