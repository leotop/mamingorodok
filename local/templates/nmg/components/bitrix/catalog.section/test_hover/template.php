...
<style type="text/css">
   ...
   /*     width: 100%;
    ...
    .fast_view{
        ...
        background: rgba(0, 0, 0, 0) linear-gradient(to bottom, #ff9f01 0%, #ff701a 100%) repeat scroll 0 0; 
        border-radius:6px;
            ...
            foreach($arResult["ROWS"] as $arRow)
            {
                ...
                <li id="<?=$strMainID?>" class="li_hover_mod">
                    ...
                    <div class="catalog_bg stock-item card"> 
                        ...
                        <?  /*echo  ('http://www.mamingorodok.ru'.$arFileTmp["src"]);     
                            $arSize=getimagesize('http://www.mamingorodok.ru'.$arFileTmp["src"]);   
                            arshow($arSize);     */
