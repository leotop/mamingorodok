	...
	?>
		<tr class="line<?=$arBasketItems["PRODUCT_ID"]?>">
			...
			<td class="td2">
				...
				<img src='<?=$file["src"];?>'>
				*/?>
				<?=ShowIImage($arBasketItems["IMAGE"], 100, 100 , $arBasketItems['NAME'])?>
				</div>
				<div class="bskt_info">
				<div class="bskt_lnk"><a href="<?=$arBasketItems["DETAIL_PAGE_URL"]?>"><?=$arBasketItems["NAME"]?></a></div>
				...
				<?/*<div class="bskt_color">Цвет: <?=$arBasketItems["COLOR"]?></div>
				<div class="bskt_size">Размер: <?=$arBasketItems["SIZE"]?></div>*/?>
				</div>
				<div class="clear"></div>
			</td>
			<td class="td3"><?=intval($arBasketItems["PRICE"])?> руб.</td>
			<td class="td4">х</td>
...
<div class="allSum">
	<div class="total">Итого без стоимости доставки: <span class="redPr"><span class="allPrice"><?=$arResult["allSum"]?></span> руб.</span></div>
