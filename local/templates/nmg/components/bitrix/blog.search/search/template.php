...
<form method="get" class="jqtransform" action="<?=$arParams["SEARCH_PAGE"]?>">
<input type="hidden" name="<?=$arParams["PAGE_VAR"]?>" value="search">
<table cellspacing="2" cellpadding="0" border="0" class="blog-search">
	<tr>
	<td><input type="text" name="q" class="searchBlogPage" value="<?=$arResult["q"]?>"></td>
	<td  class="btnSB2">
		<select name="where">
	...
	<td class="btnSB"><input  type="submit" value="&nbsp;&nbsp;&nbsp;Поиск&nbsp;&nbsp;&nbsp;"></td>
	</tr>
</table>
<?if($arResult["how"]=="d"):?>
