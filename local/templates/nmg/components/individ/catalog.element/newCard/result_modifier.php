...
while($arOffer = $rsOffers -> GetNext())
{
    ...
    //echo $arOffer["PROPERTY_COLOR_CODE_VALUE"]."<br>";
	if(strlen($strStartColor)<=0) $strStartColor = $arOffer["PROPERTY_COLOR_CODE_VALUE"];
	if(strlen($strStartSize)<=0) $strStartSize = $arOffer["PROPERTY_SIZE_VALUE"];
}
