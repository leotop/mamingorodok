...
foreach($arResult["ORDER_PROPS_PRINT"] as $arProp)
	$arResult["PROP_TMP"][$arProp["ID"]] = $arProp;
?>
<div>
...
<div class="basketResult">
	...
	<p class="black"><b>Заказчик:</b> <?=$arResult["PROP_TMP"][2]["VALUE_FORMATED"]?> [<?=$arResult["PROP_TMP"][5]["VALUE_FORMATED"]?>]</p>
	<p class="black"><b>Телефон:</b> <?=$arResult["PROP_TMP"][3]["VALUE_FORMATED"]?></p>
	<p class="black"><b>Адрес доставки:</b> <?=$arResult["PROP_TMP"][4]["VALUE_FORMATED"]?>,
	<?=$arResult["PROP_TMP"][6]["VALUE_FORMATED"]?><?if(!empty($arResult["PROP_TMP"][7]["VALUE_FORMATED"])):?>
	<p class="black"><b>Комментарий:</b> <?=$arResult["PROP_TMP"][7]["VALUE_FORMATED"]?></p><?endif;?>
...
<table width="100%" class="resultPT">
	...
	<tr >
		<td >
		<div class="pnk bold">Способ доставки <a href="" class="grey backstep">Изменить</a></div>	
		<div class="sm">
		<?
