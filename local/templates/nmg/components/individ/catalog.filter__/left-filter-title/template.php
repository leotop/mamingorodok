...
<?/*<script type="text/javascript" src="<?=SITE_TEMPLATE_PATH?>/components/individ/catalog.filter/left-filter-title/script.js"></script>*/?>
...
<script>
    ...
    <?foreach($arPropCodesWithoutCH_Num as $prop):?>
        ...
        arNumPropsRange["<?=$prop?>"]["MAX"] = <?=$arNumPropsRange[$prop]["MAX"]?>;
